...
func TestGetUserByID(t *testing.T) {
	...
	assert.Equal(t, foundUser.FirstName, foundUser.FirstName)
	assert.Equal(t, foundUser.LastName, foundUser.LastName)
}
...
func TestUpdateAUser(t *testing.T) {
	...
	assert.Equal(t, updatedUser.FirstName, updatedUser.FirstName)
	assert.Equal(t, updatedUser.LastName, updatedUser.LastName)
}
